...
pg_conf = {
    ...
    'host': 'localhost',               # Update with your PostgreSQL hostmvn
    'port': 5432                       # Update with your PostgreSQL port (default is 5432)
}

# Local JSON file path
local_json_file_path = 'output.json'  # Update with your desired file path
...
try:
    ...
    with open(local_json_file_path, 'a') as local_json_file:
        ...
        cur.execute("TRUNCATE TABLE kafka_json_data")
